...
contract Legio is IERC165, IERC721, IERC721Receiver {
    ...
    function is_approved_person(uint256 __tokenId, address __operator)
    internal
    view 
    returns(bool)
    {
    ...
    function is_generally_approved(address __caller, address __operator) 
    internal 
    view 
    returns(bool)
    {
    ...
    */
    ...
    public
    override
    is_valid_address(msg.sender)
    is_valid_address(from)
    is_valid_address(to)
    {
